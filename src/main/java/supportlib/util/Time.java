...
import supportlib.util.Timer.*;
import supportlib.util.pooling.Pool.*;
import supportlib.util.pooling.*;
...
public class Time{
    ...
    private static Floatp deltaImpl = () -> Math.min(DeltaTime.getDeltaTime() * 60f, 3f);
    ...
    public static void updateGlobal(){
        globalTimeRaw += DeltaTime.getDeltaTime();
        delta = deltaImpl.get();
