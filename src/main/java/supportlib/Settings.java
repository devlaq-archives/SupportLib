...
import supportlib.func.Cons;
import supportlib.func.Prov;
import supportlib.struct.ObjectMap;
import supportlib.util.Log;
import supportlib.util.OS;
import supportlib.util.Strings;
import supportlib.util.async.Threads;
import supportlib.util.io.ReusableByteInStream;
import supportlib.util.serialization.Json;
import supportlib.util.serialization.UBJsonReader;
import supportlib.util.serialization.UBJsonWriter;
...
public class Settings{
    ...
    public void putAll(ObjectMap<String, Object> map){
        for(ObjectMap.Entry<String, Object> entry : map.entries()){
